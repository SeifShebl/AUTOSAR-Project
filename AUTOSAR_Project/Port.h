...
typedef enum
{
    PORT_RESISTOR_OFF , PORT_RESISTOR_PULL_UP , PORT_RESISTOR_PULL_DOWN
...
typedef struct 
{
    ...
    PORT_PIN_LEVEL_VALUE initial_value;
...
{
	Port_ConfigPin Pin[PORT_CONFIGURED_PORTPINS];
} Port_ConfigType;
...
/* Function for PORT refreshDirection API */
